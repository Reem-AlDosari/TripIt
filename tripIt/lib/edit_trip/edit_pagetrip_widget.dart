...
class edit_pagetrip_widget extends StatefulWidget {
  final DocumentReference<Object> doc;
  const edit_pagetrip_widget({Key key, this.doc}) : super(key: key);
  @override
  _PageTwoState createState() => _PageTwoState();
}

class _PageTwoState extends State<edit_pagetrip_widget> {
  Future<void> _editrecord(String record, String text) async {
    ...
    if (recordList.length <= 1 && recordList1.length <= 1) {
      widget.doc.update({
        "Line": record,
      ...
      try {
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return AlertDialog(
              title: Text('trip is updated successfully'),
...
//---------------------------End
  ...
  //var colorcode = {0xFFF44336,0XFF2196F3};
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          if (imageURL.isNotEmpty) {
            await _editrecord(lineController,
