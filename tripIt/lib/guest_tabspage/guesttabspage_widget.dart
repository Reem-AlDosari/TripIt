...
import 'package:trip_it/guest_tabspage/memberpage.dart';
...
class guestTabspageWidget extends StatefulWidget {
  guestTabspageWidget({Key key}) : super(key: key);

  @override
  _guestTabspageWidgetState createState() => _guestTabspageWidgetState();
}

class _guestTabspageWidgetState extends State<guestTabspageWidget> {
