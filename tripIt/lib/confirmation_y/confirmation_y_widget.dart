...
class ConfirmationYWidget extends StatefulWidget {
  ConfirmationYWidget({Key key}) : super(key: key);

  @override
  _ConfirmationYWidgetState createState() => _ConfirmationYWidgetState();
}

class _ConfirmationYWidgetState extends State<ConfirmationYWidget> {
